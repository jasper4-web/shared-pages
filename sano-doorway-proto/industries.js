...
window.SANO_CAPABILITIES = [
  ...
  { key:'booking', short:'Booking', tier:'starter', name:'Booking &amp; reminders',
    ...
    more:'It only ever offers times you are actually free, with travel and buffer built in, and it writes straight into the calendar you already use. Reminders go out before the day so people turn up.' },
...
window.SANO_APP = {
  ...
  'plumbing': {
    ...
    miss: ['Water heater is leaking all over the garage floor','Shut the valve on top and we will get someone out. Tomorrow 9:00 or 11:30?','11:30 — valve is off','Booked ✓ Tomorrow 11:30 AM. Keep it off and we will text before arriving.'],

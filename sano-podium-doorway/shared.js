      ...
      '<nav aria-label="Main"><ul class="nav-links">' +
        '<li class="' + (page === 'product' ? 'active' : '') + '"><a href="what-we-run.html"' + (page === 'product' ? (here('what-we-run.html') ? ' aria-current="page"' : ' aria-current="true"') : '') + '>What we run ' + caret + '</a>' +
          '<div class="dropdown">' +
            ...
            '<a href="what-we-run.html#backoffice"><b>Hiring &amp; team systems</b><span>Hiring, training &amp; paperwork, run for you</span></a>' +
    ...
    '<footer><div class="wrap">' +
      '<nav aria-label="Footer"><div class="foot-grid">' +
        ...
        '<div class="foot-col"><h2 class="foot-col-h">What we run</h2>' +
          ...
          '<a href="what-we-run.html#marketing">Marketing &amp; payments</a><a href="what-we-run.html#backoffice">Hiring &amp; team systems</a><a href="sample-blueprint.html">Sample blueprint</a></div>' +

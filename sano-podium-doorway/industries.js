...
window.SANO_INDUSTRIES = [
  ...
  },
  {
    ...
    faqs: [
      ...
      ['Can it answer messages from social too?', 'Yes — from Growth up, Instagram and Facebook messages land in the same inbox as your calls and texts, and get answered and booked the same way.'],
...
window.SANO_CAPABILITIES = [
  ...
  { key:'socialdm', short:'IG &amp; FB DMs', tier:'growth', name:'Instagram &amp; Facebook messages answered',
    d:'DMs on Instagram and Facebook get answered in the same inbox as your calls and texts — one conversation, wherever it started.',
    more:'People ask real buying questions in DMs, and a DM that sits for a day is a customer somewhere else by dinner. From Growth up, those messages land in the same inbox as your calls and texts, get answered the same way, and get booked the same way.' },
  ...
  { key:'recall', short:'Rebooking', tier:'growth', name:'Customers brought back when they’re due',
    d:'Rebooking on their natural cycle, win-backs, and day-after check-ins — the customers you already earned, brought back before they drift.',
    more:'Every business has a natural cycle — the next service, the next visit, the next season. This watches the calendar for you: the customer who is due gets the rebooking text, the one who went quiet gets the win-back, and the day-after check-in catches a problem while it is still small. None of it is written by you.' },
  { key:'campaigns', short:'Campaigns', tier:'growth', name:'Campaigns to your own list',
    d:'Email and text campaigns to your customer list — seasonal offers and announcements, instead of paying to find new people.',
    more:'Email and text to the customers you have already earned — seasonal offers, announcements, anything you want said. Cheaper than finding new people, and it runs without you writing a word.' },
  ...
  { key:'hiring', short:'Hiring pipeline', tier:'growth', name:'A hiring pipeline',
    d:'Applications, screening, tryouts, hired — with automatic follow-up, so a good candidate is never lost to silence.',
    more:'Every application lands in one pipeline — applied, screened, tryout, hired — and the follow-up happens automatically, so the good candidate is not lost to a faster offer. For licensed trades, a license check is built into the screening step.' },
  { key:'training', short:'Training portal', tier:'growth', name:'Your training, turned into a portal',
    d:'Quizzes and completion tracking, so nobody touches a customer until they’ve passed YOUR bar.',
    more:'We take how you already train people and turn it into a portal — short lessons, quizzes, and completion tracking. You can see exactly who has passed what, and nobody touches a customer until they have passed your bar.' },
  { key:'scorecards', short:'Tryout scorecards', tier:'growth', name:'Tryout scorecards',
    d:'Every candidate’s results on record, so the hire is a decision you can look back at — not a hunch.',
    more:'Every tryout gets scored the same way, and every candidate’s results stay on record. When you compare two people, you are comparing scorecards — not memories.' },
  { key:'esign', short:'E-sign paperwork', tier:'growth', name:'Onboarding paperwork, signed electronically',
    d:'The paperwork goes out, gets signed from a phone, and files itself.',
    more:'The paperwork goes out the moment you say “hired,” gets signed from a phone, and files itself. To be clear about the boundary: this is paperwork collection and e-signature — not HR, payroll, or classification compliance. How you classify and pay your team is a question for an employment attorney or payroll service — and we’ll say so.' },
  { key:'inventory', short:'Inventory', tier:'growth', name:'Simple inventory with low-stock alerts',
    d:'A simple count of what you use and sell, with an alert before you run out.',
    more:'Not a warehouse system — a simple count of the things you use and sell, kept current, with an alert before you run out of the one thing tomorrow’s jobs need.' },
...
window.SANO_CAPS_BY_INDUSTRY = {
  ...
  'auto': {
    ...
    recall: 'Oil-change and inspection reminders go back out to the cars you’ve already worked on.',
  ...
  'med-spa': {
    ...
    socialdm: 'The Instagram DM asking about a treatment gets answered in the same inbox as your calls and texts — before she books somewhere else.',
    recall: 'The client who’s due for her next visit gets the rebooking text on her natural cycle — before she drifts to whoever messaged first.',
    campaigns: 'New-treatment offers go out to past clients on a schedule you approve.',
  ...
  'dental': {
    ...
    recall: 'Recall and hygiene reminders go out on schedule, so the chair doesn’t sit empty.',

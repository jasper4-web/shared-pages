...
window.SANO_BOT_CONFIG = {
  ...
  kb: [
    ...
    /* ---------------- THE PACKAGE ---------------- */
    {
      ...
      a: "You're on the <b>Growth package</b> and you get all of it — nothing to choose between. The seven that matter most for you:<br><br>1. <b>Missed-call text-back</b><br>2. <b>Auto-answers</b> for your repeat questions<br>3. <b>Real-availability booking</b><br>4. <b>Review engine</b><br>5. <b>Customer log</b> — vehicles, plates, history<br>6. <b>Your number, untouched</b><br>7. <b>The app + a plain-English monthly rundown</b><br><br>Growth also includes <b>customers brought back when they're due</b> (rebooking, win-backs, day-after check-ins), <b>Instagram &amp; Facebook messages answered in the same inbox</b> as your calls and texts, and <b>the hiring &amp; team systems</b> — a hiring pipeline, your training turned into a portal with quizzes, tryout scorecards, onboarding paperwork signed electronically, and simple inventory with low-stock alerts. On the paperwork, the honest boundary: that's collection &amp; e-signature — not HR, payroll, or classification compliance; how you classify and pay your team is a question for an employment attorney or payroll service, and we'll say so.<br><br>Ask me about any one of them and I'll go deeper.",

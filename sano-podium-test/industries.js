...
['How do you handle patient privacy and HIPAA?', 'Straight answer: the assistant only collects what is needed to book or route a call — name, contact details, and the reason for the visit. It does not ask for or store clinical information, and anything sensitive goes straight to your team instead of being handled automatically. Where a signed business associate agreement is required for how you want to use it, we will tell you up front whether we can sign one — before you pay us anything. If your setup needs more than that, we will tell you before you pay us.'],
      ['Is the texting compliant? I don\'t want trouble.', 'Here is how we handle it, rather than a blanket promise. Marketing texts only go to people who have given written permission. Every one has a clear way to stop, and we honor it immediately. We register your number for business texting properly instead of blasting from an unregistered line. We are not your lawyers, and we will decline a campaign we think puts you at risk.']
    ]
  },
  {

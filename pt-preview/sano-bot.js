/* ============================================================
   Answer bot — engine only.
   The answer set is supplied by the host page as
   window.SANO_BOT_CONFIG before this file loads.

   Rules:
   - Never return the same fallback twice in a row.
   - Low confidence surfaces choices, never a confident wrong answer.
   - Every answer ends with somewhere to go next.
   - Anything it does not know escalates to a human, by name.
   ============================================================ */
(function () {
  'use strict';
